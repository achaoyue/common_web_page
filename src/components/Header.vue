<template>
  <div class="header-wrapper">
    ...
    <el-menu :default-active="activeIndex" class="el-menu-demo" mode="horizontal" router>
      <el-menu-item index="Home" :route="{ name: 'StockBoard' }">大盘</el-menu-item>
      <el-menu-item index="Stock" :route="{ name: 'PerfectList' }">选股</el-menu-item>
      <el-menu-item index="Stock" :route="{ name: 'NoticeHistory' }">通知历史</el-menu-item>
      <el-menu-item index="Stock" :route="{ name: 'HistorySold' }">历史清空</el-menu-item>
